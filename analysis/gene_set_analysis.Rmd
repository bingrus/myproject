...
```{r camera to table,echo=FALSE,out.height=960,out.width=960}
...
#  Colv="NA")   
#converttopvalue(1)
include_graphics('gs-hp_1.pdf')
```

```{r interactive 0,echo = FALSE,fig.width=10,fig.height=10,include = FALSE}
...
```{r plot,echo = FALSE,out.width= 960, out.height= 960}
...
```{r heatmap2,echo = FALSE,out.width= 960, out.height= 960}
